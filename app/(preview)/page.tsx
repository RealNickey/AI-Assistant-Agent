  ...
  const { messages, input, handleInputChange, handleSubmit, isLoading } =
    useChat({
      ...
      onError: (error) => {
        ...
        toast.error("You've been rate limited or an error occurred. Please try again later!");
      },
    });
  ...
  return (
    <div className="flex justify-center items-start sm:pt-16 min-h-screen w-full dark:bg-neutral-900 px-4 md:px-0 py-4">
      <div className="flex flex-col items-center w-full max-w-[500px]">
        ...
        >
          <div className="border rounded-lg p-4 bg-neutral-50 dark:bg-neutral-800 dark:border-neutral-700">
            <ProviderSelector
          ...
          <div className="flex flex-col w-full justify-between gap-2">
            <form onSubmit={handleSubmit} className="flex space-x-2">
              <Input
                ...
                required
                value={input}
                placeholder={`Ask me anything... ${selectedProvider ? `(using ${selectedProvider})` : '(auto provider)'}`}
