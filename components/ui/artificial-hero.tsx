  ...
  return (
    <div ref={containerRef} className="relative w-full h-screen overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 p-6 flex justify-between items-center">
        ...
        <div className="flex gap-8 font-sans text-[11px] font-medium tracking-wider uppercase">
          <a href="#" className="text-white no-underline opacity-90 hover:opacity-100 transition-opacity">
            Creative Journey
          </a>
          <a href="#" className="text-white no-underline opacity-90 hover:opacity-100 transition-opacity">
            About
        ...
        <div className="font-sans text-[11px] font-medium text-white opacity-90 tracking-wider uppercase">
          + Connect
        </div>
      </nav>
      ...
      {/* Large text */}
      <div 
        className="fixed bottom-[15%] left-0 right-0 z-20 pointer-events-none"
        style={{
      ...
      >
        <div className="text-center text-white text-[120px] font-bold tracking-wider">
          ARTIFICIAL
        </div>
      </div>
      ...
      {/* Left side text */}
      <div 
        className="fixed left-8 top-[40%] z-20 text-white text-sm leading-relaxed"
        style={{
      ...
      {/* Right side text */}
      <div 
        className="fixed right-8 top-[40%] z-20 text-white text-sm leading-relaxed"
        style={{
          transform: `translateX(${scrollProgressRef.current * 200}px)`,
          opacity: Math.max(0, 1 - scrollProgressRef.current * 2),
          transition: 'transform 0.1s ease-out'
      ...
      {/* Bottom text */}
      <div 
        className="fixed bottom-[8%] left-8 z-20 text-white text-xs opacity-80"
        style={{
